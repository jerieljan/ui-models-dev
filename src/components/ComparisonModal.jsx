...
const ComparisonModal = ({ show, models, providers, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-surface rounded-lg shadow-lg w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-card-border">
                    ...
                    {models.map(model => (
                      <th key={`${model.providerId}-${model.id}`} className="text-left p-2 min-w-[200px]">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-card-border bg-secondary bg-opacity-20">
                    <td colSpan={models.length + 1} className="p-2 font-medium sticky left-0 bg-secondary bg-opacity-20">
                      Basic Information
                    </td>
                  </tr>
                  <tr className="border-b border-card-border">
